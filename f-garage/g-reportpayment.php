            ...
            <div class="row justify-content-md-center row-cols-1 row-cols-md-2 g-4">
                <div class="col-12">
                    <div class="card shadow mb-5 bg-body rounded">
                        ...
                        <h5 class="card-title">Report Generate - Payments</h5><hr>
                         
                            <div class="mb-3">
                                <form action="g-reportpayment-process.php" method="GET">
                                <div class="d-flex">
                                    ...
                                    <input class="form-control me-3" type="date" name="end_date" id="end_date" value="<?= $endDate ?>">
                                </div>
