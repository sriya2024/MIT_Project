                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <div class="accordion-item">
                        ...
                        <button class="accordion-button collapsed btn btn-outline-secondary" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                            <p><b><?php echo $rowsearch['newsTitle']; ?></b> </br> <i> Read More</i></P>
                        </button>
                        </h2>
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                        <div class="accordion-body"><p>News Id:<?php echo $rowsearch['newsId']; ?>
                        </br><?php echo $rowsearch['newsDescription']; ?>
                        </br><?php echo $rowsearch['newsDate']; ?>
