                    ...
                    <div class="card shadow bg-body rounded">
                        <div class="text-left p-4" style="background-color: #e3f2fd">
                                <div class="row">
                                    ...
                                    <a class="btn btn-primary btn-sm right" href=d-faq-add.php>Add FAQ</a>
                                    </div>
                                    <div class="col-12 col-md-8">
                                   
                                        <form class="d-flex" action="d-faqmgt.php" method="GET">
                        ...
                        <div class="card-body">
                                   ...
                                   $search = $_GET['search'] ?? '';
                                    ...
                                    if (!empty($search)) {
                                        ...
                                        WHERE (addDate LIKE '%$search%' OR faqQues LIKE '%$search%' OR faqAns LIKE '%$search%' OR addBy LIKE '%$search%')
                                       ";
                                    ...
                                    <tbody>   
                                        <tr> 
                                            <td><?php echo $rowsearch['faqId']; ?></td>
                                            <td><?php echo $rowsearch['faqQues']; ?></td>
                                            <td><?php echo $rowsearch['faqAns']; ?></td>
                                            <td><?php echo $rowsearch['addBy']; ?></td>  
                                            <td><?php echo $rowsearch['addDate']; ?></td>  
                                            <?php $faqId=$rowsearch['faqId']; ?>
                                            <td><a class="btn btn-primary btn-sm" href=d-faq-update.php?faqId=<?php echo $faqId;?>>Update</a></td>
                                            <td><a class="btn btn-danger btn-sm" onclick="confirmCancel(<?php echo $faqId; ?>)">Delete</a></td>  
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                    </table>
                            ...
                            <div class="card-body">
                                        ...
                                        <tbody>   
                                            <tr> 
                                                ...
                                                <td><a class="btn btn-danger btn-sm" onclick="confirmCancel(<?php echo $feedbackId; ?>)">Delete</a></td>     
                                            </tr>
                                            <?php } ?>
                                        </tbody>
                                        </table>
...
function confirmCancel(faqId) {
    var result = confirm("Do you want to delete?");

    if (result) {
        
        window.location.href = "d-delete-process.php?faqId=" + faqId;
    } else {
